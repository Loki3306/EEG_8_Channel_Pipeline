...
def main():
    print(f"\n===============================================================")
    print(f" STEP 2: MEASURE 64-CHANNEL CEILING")
    print(f"===============================================================")
    ...
    print(f"\n=> FINAL 64-CH NORMAL ACCURACY : {final_norm*100:.2f}%")
    print(f"=> FINAL 64-CH ZERO ACCURACY   : {final_zero*100:.2f}%")
    print(f"=> FINAL 64-CH SHUFFLE ACCURACY: {final_shuf*100:.2f}%\n")
