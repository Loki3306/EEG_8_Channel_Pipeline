...
def run_bayesian_tracking(track_set, C_xx_calib, C_xy_calib, I, N_windows, device, Q_DRIFT, R_NOISE, P_INIT, platt_clf=None, is_oracle=False):
    """
...
def process_subject(cache_file):
    ...
    # Scenario B: Soft Pseudo-Labels (N=20 -> 10s)
    acc_soft_20 = run_bayesian_tracking(track_set, C_xx_calib, C_xy_calib, I, N_windows=20, device=device, Q_DRIFT=Q_DRIFT, R_NOISE=R_NOISE, P_INIT=P_INIT, platt_clf=platt_clf)
...
def main():
    ...
    print(" Platt Scaled Probabilities + Innovation Gating + Effective N")
    print("=======================================================\n")
