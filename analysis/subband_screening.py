...
# Discovered optimal channels: C5, FCz, FC6, P9, C6, Fp1, TP8, T7
...
def evaluate_subband(name, lowcut, highcut, all_paths):
    print(f"\n===============================================================")
    print(f" SCREENING BAND: {name} ({lowcut}-{highcut} Hz)")
    print(f"===============================================================")
    
    # Filter paths to only the screening subjects
...
def main():
    ...
    evaluate_subband("Delta Band", 1.0, 4.0, paths)
    evaluate_subband("Theta Band", 4.0, 8.0, paths)
    evaluate_subband("Alpha Band", 8.0, 12.0, paths)
