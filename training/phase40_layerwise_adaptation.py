...
def run_layerwise_study():
    print("=======================================================")
    print(" PHASE 40: LAYER-WISE ADAPTATION STUDY (KUL -> AASD)   ")
    print("=======================================================")
    ...
    configs = [
        ("ZERO_SHOT", []),
        ("LATENT_ADAPTER", []), # Special case: unfreeze adapter
    ...
    for config_name, layers_to_unfreeze in configs:
        ...
        if config_name == "LATENT_ADAPTER":
            model.use_residual_adapter = True
            for param in model.residual_adapter.parameters():
                param.requires_grad = True
            model.alpha.requires_grad = True
        else:
            model.use_residual_adapter = False
