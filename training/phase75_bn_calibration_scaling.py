...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 75: BATCHNORM CALIBRATION SCALING LAWS")
    print(" Fine-tuning BatchNorm Universal Backbone with varying data fractions")
    print("=======================================================\n")
    ...
    for fold, (train_subjs, test_subjs) in enumerate(kf.split(subject_indices)):
        ...
        for subj in test_subjs:
            ...
            for frac in DATA_FRACTIONS:
                ...
                # Fine-tune. BatchNorm layers will smoothly adapt their running statistics to the new subject!
                ft_model.train()
                for epoch in range(FT_EPOCHS):
                    for b_e, b_a, b_b, b_y in calib_loader:
                        b_e, b_a, b_b, b_y = b_e.to(device), b_a.to(device), b_b.to(device), b_y.to(device)
                        
                        if b_e.size(0) == 1: continue # Avoid BatchNorm batch size 1 crash
    ...
    print("\n=======================================================")
    print(f" FINAL BATCHNORM SCALING LAWS (Mean across 18 Subjects):")
