...
# NO BAND SWEEPING - Pure Broadband Biological Tracking
BROADBAND = (0.5, 8.0)
RIDGE_LAMBDA = 100.0
...
def process_subject(cache_file, device_id):
    ...
    for test_idx in range(N_TRIALS):
        ...
        diffs, labels = evaluate_trial_directional(W_final_L, W_final_R, data_cache[test_idx])
    ...
    print(f"  [{subj_name}] Finished on {device}. Broadband AUROC: {global_auc:.4f}")
...
def main():
    ...
    print(f"\n=======================================================")
    print(f" PHASE 122: BROADBAND DIRECTIONAL LOTO (0.5 - 8.0 Hz)")
    ...
    print("\n=======================================================")
    print(" PHASE 122 BROADBAND DIRECTIONAL LOTO RESULTS")
    print("=======================================================")
