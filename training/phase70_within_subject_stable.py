...
BATCH_SIZE = 128 # Smaller batch size for single subject data
EPOCHS = 15      
LR = 1e-3
...
# -------------------------------------------------------------------------
# ARCHITECTURE (Pure CNN + LSTM, No Adapters)
# -------------------------------------------------------------------------
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 70: WITHIN-SUBJECT STABLE BASELINE")
    print(" Falsification Test: Does the biological signal exist?")
    print(" Protocol: 80% Train / 20% Test per Subject")
    print("=======================================================\n")
    ...
    for subj_idx, cache_path in enumerate(sorted(cache_files)):
        ...
        print(f"Subject {subj_idx:02d} | Train Seq: {len(train_dataset):4d} | Test Seq: {len(test_dataset):4d} | Best AUROC: {best_auc:.4f}")

    print("\n=======================================================")
    print(f" FINAL RESULTS:")
    print(f" Average Within-Subject AUROC: {np.mean(subject_aurocs):.4f}")
    print("=======================================================\n")
