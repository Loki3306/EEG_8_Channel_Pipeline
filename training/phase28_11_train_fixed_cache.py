...
def main():
    print("==================================================")
    print("=== PHASE 28.11 FAST TRAINING ON 1-8Hz CACHE ====")
    print("==================================================\n")
    ...
    # FATAL BUG FIX: Nyquist = 64.0 (128Hz sampling rate) for a true 1-8 Hz filter
    ...
    for trial_idx in range(data_all.shape[2]):
        ...
        # FATAL BUG FIX: Properly Z-score audio per-trial to match KUL
    ...
    if final_acc > 0.65:
        print("MASSIVE SUCCESS! The model is rapidly learning the corrected 1-8Hz dataset.")
        print("The epoched latency bug + the Nyquist filter bug were the fatal flaws.")
    else:
        print("INCOMPLETE. The model is STILL struggling. We must test if the targets (179 vs 184) are inverted.")
