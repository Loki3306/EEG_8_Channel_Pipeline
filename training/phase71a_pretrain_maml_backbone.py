...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 71A: FOLD-SPECIFIC UNIVERSAL PRE-TRAINING")
    print(" Pre-training 4 isolated backbones to prevent data leakage")
    print("=======================================================\n")
    ...
    # Exact same fold split as Phase 71B
    ...
    for fold, (train_subjs, test_subjs) in enumerate(kf.split(subject_indices)):
        ...
        print(f"  Training Backbone on {len(fold_train_seqs)} sequences...")
        ...
        save_path = f"maml_backbone_fold_{fold}.pt"
        torch.save(model.state_dict(), save_path)
        print(f"  [+] Saved {save_path}")

    print("\nPhase 71A Complete. Fold-specific backbones are ready for Phase 71B Meta-Fine-Tuning.")
