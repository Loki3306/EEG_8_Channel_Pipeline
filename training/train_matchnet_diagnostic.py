...
def train_matchnet_loso(eeg_model, channels, lowcut, highcut):
    ...
    diagnostic_subjects = ["S8", "S10", "S12", "S16"]
    diagnostic_stems = [f"{sub}_data_preproc" for sub in diagnostic_subjects]
    folds = [fold for fold in folds if fold[0].stem in diagnostic_stems]
