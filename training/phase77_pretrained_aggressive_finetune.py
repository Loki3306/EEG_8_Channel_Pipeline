...
# THE PHASE 76 AGGRESSIVE OPTIMIZATION SCHEDULE
FT_EPOCHS = 15
FT_LR = 1e-3
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 77: THE FINAL INITIALIZATION FALSIFICATION")
    print(" Fine-tuning Universal Backbone with AGGRESSIVE Phase 76 Schedule")
    print(" Hypothesis: 1e-3 LR allows escape from the 'Anti-Correlation Trap'")
    print("=======================================================\n")
    ...
    for fold, (train_subjs, test_subjs) in enumerate(kf.split(subject_indices)):
        ...
        ckpt_path = Path(f"bn_backbone_fold_{fold}.pt")
        if not ckpt_path.exists():
            print(f"[FATAL] Missing {ckpt_path}. Did you run phase74_pretrain_bn_backbone.py?")
            return
        ...
        for subj in test_subjs:
            ...
            print(f"  Zero-Shot AUROC: {zs_auc:.4f}")
            ...
            for frac in DATA_FRACTIONS:
                ...
                print(f"  - FT {frac*100:5.1f}% ({num_calib:4d} seqs | ~{calib_time_min:4.1f} min): {best_auc:.4f}")

    print("\n=======================================================")
    print(f" FINAL AGGRESSIVE SCALING LAWS (Mean across 18 Subjects):")
