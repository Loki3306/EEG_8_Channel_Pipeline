...
# -------------------------------------------------------------------------
# ARCHITECTURE (Phase 62: Calibration Adapter)
# -------------------------------------------------------------------------
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 62: TRUE CALIBRATION ADAPTER EXPERIMENT")
    print("=======================================================\n")
    ...
    # We have 18 subjects. 
    # Let's use first 14 for UNIVERSAL PRE-TRAINING, and last 4 for TEST/CALIBRATION.
    ...
    for subj in test_subjs:
        ...
        # Now, Freeze Backbone, Unfreeze Adapter
        for param in model.parameters():
            param.requires_grad = False
        for param in model.adapter.parameters():
            param.requires_grad = True
            
        calib_optimizer = optim.Adam(model.adapter.parameters(), lr=1e-2) # Higher LR for fast fine-tuning
        
        # Calibrate for 10 epochs
        for epoch in range(CALIB_EPOCHS):
            ...
            for b_e, b_a, b_b, b_y in calib_loader:
                ...
                # Identity-Centered Regularization (as recommended by ChatGPT)
                identity = torch.eye(8, device=device)
                adapter_reg = 0.01 * ((model.adapter.mixer.weight[:, :, 0] - identity)**2).sum()
