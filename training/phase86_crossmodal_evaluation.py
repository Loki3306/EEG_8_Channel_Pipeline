...
# We evaluate S11 (The Acoustic Failure) and S16 (The Acoustic Master) to see if Attention fixes S11
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 86: CROSS-MODAL ATTENTION GATE EVALUATION")
    print(" Testing if Brain-guided Spectral Attention rescues Subject 16.")
    print("=======================================================\n", flush=True)
    ...
    for subj_idx in EVAL_SUBJECTS:
        ...
        # Initialize TCNAADModel with audio_channels=16 to trigger Spatial AND Spectral Attention
        ...
        print(f"  Multiband + Cross-Modal Gate: {best_auc:.4f}")
