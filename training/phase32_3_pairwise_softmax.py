...
def run_pairwise_softmax():
    print("--- 1. Loading Data for Phase 32C Pairwise Softmax ---")
    ...
    # Add heavy dropout to projection heads to prevent representation collapse
    for module in model.modules():
        if isinstance(module, nn.Sequential) and len(module) > 0 and isinstance(module[-1], nn.Linear):
            # This is fragile but we just want to inject dropout if possible
            # We won't modify the model directly to avoid breaking Phase 32A/B.
            pass
