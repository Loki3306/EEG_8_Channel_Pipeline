...
# -------------------------------------------------------------------------
# ARCHITECTURE (Phase 66 Stable Calibration)
# -------------------------------------------------------------------------
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 66: ULTIMATE STABLE CALIBRATION EXPERIMENT")
    print(" Protocol: 4-Fold LOSO with Stable Sequences")
    print(f" Exclusion Zone: {EXCLUSION_SEC}s")
    print(f" Sequence Length: {SEQ_SEC}s")
    print("=======================================================\n")
    ...
    for fold, (train_subjs, test_subjs) in enumerate(kf.split(subject_indices)):
        ...
        print("\n--- STEP 2: TEST-TIME CALIBRATION (Stable Windows Only) ---")
        for subj in test_subjs:
            ...
            calib_loader = DataLoader(StableSequenceDataset(calib_trials), batch_size=BATCH_SIZE, shuffle=True)
