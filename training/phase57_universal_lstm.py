...
class SequenceAADModel(nn.Module):
    def __init__(self, eeg_channels=60, latent_dim=64, lstm_hidden=64):
        ...
        # LSTM takes embeddings + similarities
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 57: UNIVERSAL LSTM SEQUENCE MODEL (ALL SUBJECTS)")
    print("=======================================================\n")
    
    trial_eeg, trial_a, trial_b, trial_lbl = [], [], [], []
    
    print(f"Loading {len(cache_files)} subjects into Universal Training Pool...")
    ...
    print(f"Total Universal Sequences Extracted: {len(trial_eeg)}")
            
    kf = KFold(n_splits=5, shuffle=True, random_state=42) # Randomly shuffle across all subjects!
    fold_aurocs = []
