...
# -------------------------------------------------------------------------
# ARCHITECTURE (Phase 61B: Dilations ONLY)
# -------------------------------------------------------------------------
class LocalEncoder(nn.Module):
    def __init__(self, in_channels, out_dim=64):
        ...
        # 1. Dilated Temporal Convolutions (Wavenet Style) ONLY
        self.conv1 = nn.Conv1d(in_channels, 16, kernel_size=17, padding=16, dilation=2)
        self.bn1 = nn.BatchNorm1d(16) # Keeping BatchNorm (baseline)
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 61B: ABLATION (DILATIONS ONLY)")
    print("=======================================================\n")
    ...
    print(f"\nAVERAGE 5-FOLD PHASE 61B AUROC: {np.mean(fold_aurocs):.4f}")
