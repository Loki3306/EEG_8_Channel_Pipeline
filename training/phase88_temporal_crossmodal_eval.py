...
# We evaluate S11 and S16 to see if Temporal Cross-Modal Attention fixes S16's temporal bottleneck
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 88: DEEP TEMPORAL CROSS-MODAL GATE EVALUATION")
    print(" Testing if Residual Temporal Gating rescues Subject 16.")
    print("=======================================================\n", flush=True)
    ...
    for subj_idx in EVAL_SUBJECTS:
        ...
        # Initialize TCNAADModel with DeepTemporalCrossModalGate
        model = TCNAADModel(eeg_channels=8, latent_dim=64, tcn_channels=[64, 64, 64], kernel_size=2, dropout=0.3, use_wavlm=False, audio_channels=16, attention_type='temporal_cross_modal').to(device)
        ...
        print(f"  Multiband + Deep Temporal Cross-Modal Gate: {best_auc:.4f}")
