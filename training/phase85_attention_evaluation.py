...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 85: SPATIAL-SPECTRAL ATTENTION EVALUATION")
    print(" Testing if adaptive attention rescues Subject 11.")
    print("=======================================================\n", flush=True)
    ...
    for subj_idx in EVAL_SUBJECTS:
        ...
        print(f"  Multiband + Spatial-Spectral Attention: {best_auc:.4f}")
