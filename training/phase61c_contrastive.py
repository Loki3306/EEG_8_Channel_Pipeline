...
# -------------------------------------------------------------------------
# ARCHITECTURE (Phase 61C: Contrastive Loss ONLY)
# -------------------------------------------------------------------------
...
def main():
    ...
    print("\n=======================================================")
    print(" PHASE 61C: ABLATION (CONTRASTIVE LOSS ONLY)")
    print("=======================================================\n")
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(all_trials)):
        ...
        for epoch in range(EPOCHS):
            model.train()
            for batch_idx, (b_e, b_a, b_b, b_y) in enumerate(train_loader):
                ...
                if batch_idx == 0:
                    print(f"      [DEBUG] BCE: {bce_loss.item():.4f} | Contrastive: {contrastive_loss.item():.4f} | Total: {loss.item():.4f}")
    ...
    print(f"\nAVERAGE 5-FOLD PHASE 61C AUROC: {np.mean(fold_aurocs):.4f}")
